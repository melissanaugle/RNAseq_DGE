...
source("/opt/trinityrnaseq-Trinity-v2.4.0/Analysis/DifferentialExpression/R/heatmap.3.R")
source("/opt/trinityrnaseq-Trinity-v2.4.0/Analysis/DifferentialExpression/R/misc_rnaseq_funcs.R")
source("/opt/trinityrnaseq-Trinity-v2.4.0/Analysis/DifferentialExpression/R/pairs3.R")
data = primary_data
samples_data = read.table("/home/naug7321/replicates.txt", header=F, check.names=F, fill=T)
...
write.table(sample_cor, file="diffExpr.P0.001_C2.matrix.log2.sample_cor.dat", quote=F, sep='	')
